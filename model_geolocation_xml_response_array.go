...
// checks if the GeolocationXMLResponseArray type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GeolocationXMLResponseArray{}
...
func NewGeolocationXMLResponseArray() *GeolocationXMLResponseArray {
	this := GeolocationXMLResponseArray{}
	return &this
}
...
type NullableGeolocationXMLResponseArray struct {
	value *GeolocationXMLResponseArray
	isSet bool
}

func (v NullableGeolocationXMLResponseArray) Get() *GeolocationXMLResponseArray {
	return v.value
}

func (v *NullableGeolocationXMLResponseArray) Set(val *GeolocationXMLResponseArray) {
	v.value = val
	v.isSet = true
}

func (v NullableGeolocationXMLResponseArray) IsSet() bool {
	return v.isSet
}

func (v *NullableGeolocationXMLResponseArray) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGeolocationXMLResponseArray(val *GeolocationXMLResponseArray) *NullableGeolocationXMLResponseArray {
	return &NullableGeolocationXMLResponseArray{value: val, isSet: true}
}
