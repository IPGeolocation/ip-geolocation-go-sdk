...
// checks if the SecurityAPIResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecurityAPIResponse{}
...
type NullableSecurityAPIResponse struct {
	value *SecurityAPIResponse
	isSet bool
}

func (v NullableSecurityAPIResponse) Get() *SecurityAPIResponse {
	return v.value
}

func (v *NullableSecurityAPIResponse) Set(val *SecurityAPIResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSecurityAPIResponse) IsSet() bool {
	return v.isSet
}
...
func NewNullableSecurityAPIResponse(val *SecurityAPIResponse) *NullableSecurityAPIResponse {
	return &NullableSecurityAPIResponse{value: val, isSet: true}
}
