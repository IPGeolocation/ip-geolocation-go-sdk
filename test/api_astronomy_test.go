...
func Test_ipgeolocationsdk_AstronomyAPIService(t *testing.T) {
	...
	t.Run("Test AstronomyAPIService GetAstronomyDetails", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.AstronomyAPI.GetAstronomyDetails(ctx).Execute()
