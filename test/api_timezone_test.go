...
func Test_ipgeolocationsdk_TimezoneAPIService(t *testing.T) {
	...
	t.Run("Test TimezoneAPIService GetTimezoneInfo", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.TimezoneAPI.GetTimezoneInfo(ctx).Execute()
