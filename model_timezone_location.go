...
// checks if the TimezoneLocation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimezoneLocation{}
...
func (v NullableTimezoneLocation) Get() *TimezoneLocation {
	return v.value
}

func (v *NullableTimezoneLocation) Set(val *TimezoneLocation) {
	v.value = val
	v.isSet = true
}
...
func NewNullableTimezoneLocation(val *TimezoneLocation) *NullableTimezoneLocation {
	return &NullableTimezoneLocation{value: val, isSet: true}
}
